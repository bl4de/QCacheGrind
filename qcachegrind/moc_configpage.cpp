...
static constexpr auto qt_meta_stringdata_CLASSConfigPageENDCLASS = QtMocHelpers::stringData(
    "ConfigPage"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSConfigPageENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSConfigPageENDCLASS_t qt_meta_stringdata_CLASSConfigPageENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10)   // "ConfigPage"
    },
    "ConfigPage"
};
