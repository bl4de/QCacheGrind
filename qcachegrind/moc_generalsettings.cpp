...
static constexpr auto qt_meta_stringdata_CLASSGeneralSettingsENDCLASS = QtMocHelpers::stringData(
    "GeneralSettings"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSGeneralSettingsENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSGeneralSettingsENDCLASS_t qt_meta_stringdata_CLASSGeneralSettingsENDCLASS = {
    {
        QT_MOC_LITERAL(0, 15)   // "GeneralSettings"
    },
    "GeneralSettings"
};
